    ...
    <main className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
      <section className="w-full max-w-md rounded-xl bg-white shadow-lg p-8">
        ...
        <div className="mb-4 rounded-lg border border-amber-200 bg-amber-50 p-3 text-xs text-amber-900">
          <p className="font-semibold">초기 계정</p>
          <p>ADMIN: bs@alles.local, sj@alles.local</p>
          <p>STAFF: yr@alles.local, ik@alles.local</p>
          <p>초기 비밀번호는 환경변수(SEED_ADMIN_PASSWORD / SEED_STAFF_PASSWORD) 값입니다.</p>
        </div>
